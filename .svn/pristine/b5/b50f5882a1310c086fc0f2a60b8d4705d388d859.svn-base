...
<div class="containerHeadline tableHeadline">
    <h2><?php echo Yii::t('global', 'Slider shows'); ?></h2>
    <form>
        <div class="input-append">
            <span class="add-on add-on-middle add-on-mini" onclick="window.location.href='<?php echo $this->createUrl('slidershow/create') ?>'"><i class="icon-plus-sign" title="<?php echo Yii::t('global','Create'); ?> "></i></span>
