    ...
    <div class="float-width ticker">
        ...
        <ul>
            <li style="margin-top: 0px;">
                <h4><a href="/organizations"> <?php echo Yii::t('global','Organizations'); ?> </a> > <a href="/organizations/<?php echo $maps['type'] ?>/<?php echo $maps['alias']; ?>"> <?php echo Yii::t('global',$maps['name']); ?>  </a> </h4>
            </li>
        </ul>
    </div>
