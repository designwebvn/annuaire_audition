                        ...
                        'columns'=>array(
                           ...
                           /* array(
                            ...
                            array(
                                ...
                                'value' => 'Utils::CER($data->unit_price)." "',
                                'type' => 'raw'
                            ),
                            array(
                                'header'=>Yii::t('global','Total'),
                                'value' => 'Utils::CER($data->unit_price * $data->qty)." "',
                                'type' => 'raw'
                            )
                        ),
                    )); ?>
                ...
                <div class="vote-content">
                    <div class="box fix_box">
                        <div class="box_right cart-result">
                            ...
                            <div class="span1"><b id="sum"><?php echo Utils::CER($model->amount-$sumShipment ) ?> </b></div>
                           <?php /*if($credit != 0){ */?><!--
                            ...
                            <div class="span1"><b id="shipment"><?php echo Utils::CER($sumShipment);//Utils::number_format($sumShipment) ?> </b></div>
                            <div class="span2"><b><?php echo Yii::t('global','Sum net') ?></b></div>
                            <div class="span1"><b id="sum_net"><?php echo Utils::CER($model->amount/(1+Yii::app()->settings->vat_tax/100)) ?> </b></div>
                            <div class="span2"><b><?php echo Yii::t('global','Value Add Tax') ?></b></div>
                            <div class="span1"><b id="value_add_tax"><?php  echo Utils::CER(($model->amount/(1+Yii::app()->settings->vat_tax/100))*Yii::app()->settings->vat_tax/100); ?> </b></div>
                            <div class="span2 fonts"><b><?php echo Yii::t('global','Total amount') ?></b></div>
                            <div class="span1 fonts"><b id="total_amount"><?php echo Utils::CER($model->amount)  ?> </b></div>
                        </div>
                    </div>
                </div>
