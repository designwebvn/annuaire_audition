...
class NewsletterController extends SiteBaseController {
    public function init()
	{
		...
		$this->breadcrumbs[ Yii::t('global', 'Newsletters') ] = array('newsletter/index');
		$this->pageTitle[] = Yii::t('global', 'Newsletters');
	}
	...
	{
		$model=Newsletter::model()->findByPk((int)$id);
		if($model===null)
