...
<div class="container-fluid">
    ...
    <?php echo CHtml::form($this->createUrl('users/admin'), 'post', array('class'=>'form-signin')); ?>
        <h2 class="form-signin-heading"><strong><?php echo Yii::t('global','ANNUAIRE'); ?></strong> <?php echo Yii::t('global','AUDITION'); ?></h2>
