...
/**
 * This is the model class for table "products_photos".
 *
 * The followings are the available columns in table 'products_photos':
 * @property integer $id
...
class ProductsPhotos extends CActiveRecord
{
	 ...
	 * @return ProductsPhotos the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, product_id, list_file, created, updated', 'safe', 'on'=>'search'),
		);
	}
