...
class Activities extends CActiveRecord
{
    ...
    function getNameActivities( $id ){
        $brand = Activities::model()->findByPk($id);
        $v     = "<label class='catProduct'> <a href=".Yii::app()->createUrl('admin/activities/view/?id='.$brand->id).">".$brand->name."</a></label>";
        return $v;
    }
