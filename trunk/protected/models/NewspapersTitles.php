...
class NewspapersTitles extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, press_id, title, theme, periodicity, created, updated, name_press', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
        ...
        $criteria->compare('press.id',$this->name_press);
