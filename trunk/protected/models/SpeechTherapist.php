 ...
 * @property SpeechTherapistAgencies[] $speechTherapistAgencies
 * @property SpeechTherapistSpecialEducationSchools[] $speechTherapistSpecialEducationSchools
 *
 */
class SpeechTherapist extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
            ...
            'speechTherapistAgencies' => array(self::HAS_MANY, 'SpeechTherapistAgencies', 'speech_therapist_id'),
            'speechTherapistSpecialEducationSchools' => array(self::HAS_MANY, 'SpeechTherapistSpecialEducationSchools', 'speech_therapist_id'),
		);
	}
    ...
    function getSpeechTherapistSpecialEducationSchoolsId(){
        if ($this->id){
            $models = SpeechTherapistSpecialEducationSchools::model()->findAllByAttributes(array('speech_therapist_id' => $this->id));
            $arr = array();
            foreach ($models as $model)
    ...
    function getSpeechTherapistSpecialEducationSchools($id){
        $catProducts = SpeechTherapistSpecialEducationSchools::model()->findAllByAttributes(array('speech_therapist_id' => $id));
        $listCatProduct ="";
        foreach($catProducts as $catProduct){
    ...
    function getSpeechTherapistAgenciesId(){
        if ($this->id){
            $models = SpeechTherapistAgencies::model()->findAllByAttributes(array('speech_therapist_id' => $this->id));
            $arr = array();
            foreach ($models as $model)
    ...
    function getSpeechTherapistAgencies($id){
        $catProducts = SpeechTherapistAgencies::model()->findAllByAttributes(array('speech_therapist_id' => $id));
        $listCatProduct ="";
        foreach($catProducts as $catProduct){
