 ...
 *
 * The followings are the available columns in table 'product_galleries':
 * @property integer $id
 ...
 */
class ProductGalleries extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ProductGalleries the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, product_id, filename', 'safe', 'on'=>'search'),
		);
	}
    ...
    function afterDelete(){        
        @unlink(Yii::app()->basePath.'/../uploads/product_gallery/'.$this->filename);
