 ...
 *
 * The followings are the available columns in table 'events_category':
 * @property integer $id
 ...
 */
class EventsCategory extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return EventsCategory the static model class
	 */
