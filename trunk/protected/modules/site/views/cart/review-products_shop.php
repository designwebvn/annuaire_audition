...
foreach ($products_shop as $product){
	...
	<tr class="product">
		...
		<td><b><?php echo Utils::number_format($product->price)?> &euro;</b></td>
        <td style="text-align: center;">
            <?php echo $order['items']['Shop']['qty_'.Yii::app()->session['shop_buy']][$product->id]?>
        </td>
		<td><b id="product-price-<?php echo $product->id?>"><?php echo Utils::number_format($product->price*$item['qty'])?> &euro;</b></td>
    </tr>
