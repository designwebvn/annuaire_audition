        ...
        <table class="table introduce introduce_<?php echo $session_name ?>">
            ...
            foreach ($products as $product):
                ...
                <tr class="product product_<?php echo $product_id ?>">
                    ...
                    <td><b><?php echo Utils::CER($product->price)?> </b></td>
                    <td>
                    ...
                    <td><b id="<?php echo $shop_id ?>_product-price-<?php echo $product->id?>"><?php echo Utils::CER($product->price*$item['qty'])?> </b></td>
        ...
        $.ajax( {
            ...
            success: function(data) {
                ...
                $.each(data, function(key, value){
                    $('#<?php echo $shop_id ?>_' + key).html(value + ' ');
                });
