    ...
    <div class="float-width ticker">
        ...
        <ul>
            <li style="margin-top: 0px;">
                <h4><a href="/speech-therapists"> <?php echo Yii::t('global','Speech Therapists'); ?> </a> > <a href="/orthophonistes/<?php echo $maps['type'] ?>/<?php echo $maps['alias']; ?>"> <?php echo Yii::t('global',$maps['name']); ?>  </a> </h4>
            </li>
        </ul>
    </div>
            ...
            <div class="float-width sec-cont2">
                ...
                <div class="announcements-content-rq">
                    ...
                    $this->widget('zii.widgets.CListView', array(
                        'dataProvider'=>$speeds,
                        'itemView'=>'../directoryOrders/gridview_orthophonistes',
                        'summaryText'=>'',
