<div class="span12">
	...
	<p>
		<input type="checkbox" id="msg_inbox" value="1" checked="checked"/><label for="msg_inbox"><?php echo Yii::t('global','Show only inbox messages')?></label>
		<input type="checkbox" id="msg_read" value="1" checked="checked"/><label for="msg_read"><?php echo Yii::t('global','Show only unread messages')?></label>
	</p>
