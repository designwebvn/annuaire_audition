<div class="span12">
	...
	<div>
		<?php  echo Yii::t('global','Your selected plan:')?>
	</div>
	<div class="web-info">
		<p><a><?php  echo Yii::t('global','Plan type: ')?><?php
		...
		<div class="web-spot"><span><?php echo $plan->permonth; ?>  <?php echo Yii::t('global','downloads per month') ?></span></div>
		<div class="web-spot"><span><?php echo $plan->price; ?> <?php echo Yii::t('global','USD per month') ?></span></div>
