		...
		<?php if(count($plans))
		{
			...
			{ ?>
				...
				<div class="span4 plan-item">
					...
					<div class="plan-spot"><span><?php echo $plan->permonth; ?> <?php echo Yii::t('global','downloads per month') ?></span></div>
					<div class="plan-spot"><span><?php echo $plan->price; ?> <?php echo Yii::t('global','USD per month') ?></span></div>
