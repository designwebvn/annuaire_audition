...
class VideoCategoriesController extends AdminBaseController {
    public function init()
	{
		parent::init();
		
		$this->breadcrumbs[ Yii::t('global', 'Video Categories') ] = array('videoCategories/index');
		$this->pageTitle[] = Yii::t('global', 'Video Categories');
	}
	...
	{
		$model=VideoCategories::model()->findByPk((int)$id);
		if($model===null)
