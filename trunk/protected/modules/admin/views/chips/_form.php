    ...
    <div class="floatingBox" style="display: block;">
        <div class="container-fluid">
            ...
            <div class="control-group">
                    ...
                    <div class="controls">
                        <select name="ChipVideos[]" id="s2_1" multiple="multiple" class="span10 validate[required]" >
                            <?php
                            $cats = array(); Videos::getTree($cats);
                            $selected = $model->getOtherChipVideos();
                    ...
                    <div class="controls">
                        ...
                        <?php echo $form->dropDownList($model,'range_id',$range_name1, array('prompt'=>' Empty ')); ?>
