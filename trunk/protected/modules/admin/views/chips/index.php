...
<div class="containerHeadline tableHeadline">
    ...
    <form>
        <div class="input-append">
            <span class="add-on add-on-middle add-on-mini" onclick="window.location.href='<?php echo $this->createUrl('chips/create') ?>'"><i class="icon-plus-sign" title="<?php echo Yii::t('global', 'Create'); ?>"></i></span>
...
<div class="container-fluid">
    ...
    'columns'=>array(
		...
		'video',
        array('name'=>'range_name', 'header'=>Yii::t('global','Range'), 'value'=>'$data->range->name', 'type'=>'raw'),
		//'range_id',
        array(
            'name' => 'created',
