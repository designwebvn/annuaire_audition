		...
		<div class="span12">
			<div class="containerHeadline tableHeadline">
				...
				<form class="header-tab-view not-bor">
					<div class="input-append">
                        <span class="add-on add-on-middle add-on-mini" onclick="window.location.href='<?php echo $this->createUrl('videos/update?id='.$model->id) ?>'"><i class="icon-edit" title="<?php echo Yii::t('global', 'Edit'); ?>"></i></span>
			...
			<div class="floatingBox table table-view-user">
				<div class="container-fluid">
                    ...
                    array('name'=>Yii::t('global', 'Articles'), 'value'=>Videos::getVideoArticles($model->id) ,'type'=>'raw'),
                    array('name'=>Yii::t('supplierProducts','Hearing Care Centers'), 'value'=>Videos::getVideosCenters($model->id) ,'type'=>'raw'),
					array('name'=>'created'),
					array('name'=>'updated'),
					),
					)); ?>
