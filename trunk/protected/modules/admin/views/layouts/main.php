...
<div id="profileContent">
    ...
    <div class="sidebarContent">
        ...
        <div class="profileBlock">
            ...
            <footer>
                <div class="profileSettingBlock editProfile" onclick="window.location.href='/admin/members/update?id=<?php echo Yii::app()->user->id; ?>'"><i class="icon-user"></i><?php  echo Yii::t('admin','Edit profile'); ?></div>
                <div class="profileSettingBlock changePassword" onclick="window.location.href='/admin/members/changepass?id=<?php echo Yii::app()->user->id; ?>&action=index'"><i class="icon-lock"></i><?php  echo Yii::t('admin','Change password'); ?></div>
                <div class="profileSettingBlock logout" onclick = "window.location.href='/logout'"><i class="icon-off"></i><?php  echo Yii::t('admin','Logout'); ?> </div>
            </footer>
        </div>
    </div>
</div>
