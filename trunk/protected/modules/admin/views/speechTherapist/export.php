...
<div class="container-fluid">
    <div class="page-header" style="border-bottom: 0px solid !important;">
        <h1>
            <?php echo Yii::t('global', 'Export'); ?>            <small><?php echo Yii::t('global', 'Speech Therapists'); ?></small>
        </h1>
    </div>
    <div class="row-fluid">
    ...
    <div class="row-fluid">
        <div class="span12">
            <div class="containerHeadline">
                <i class="icon-ok-sign"></i><h2><?php echo Yii::t('global','Speech Therapists'); ?></h2>
