            ...
            <div class="containerHeadline tableHeadline">
                ...
                <form class="header-tab-view not-bor">
                    <div class="input-append">
                        <span class="add-on add-on-middle add-on-mini" onclick="window.location.href='<?php echo $this->createUrl('speechTherapist/update?id='.$model->id) ?>'"><i class="icon-edit" title="<?php echo Yii::t('global', 'Edit'); ?>"></i></span>
            ...
            <div class="floatingBox table table-view-user">
                <div class="container-fluid">
                    ...
                    'attributes'=>array(
                                ...
                                array('name'=>Yii::t('supplierProducts','Special Education Schools'), 'value'=>SpeechTherapist::getSpeechTherapistSpecialEducationSchools($model->id) ,'type'=>'raw'),
                                array('name'=>Yii::t('supplierProducts','Agencies'), 'value'=>SpeechTherapist::getSpeechTherapistAgencies($model->id) ,'type'=>'raw'),
                                array('name'=>'created'),
                                array('name'=>'updated'),
                    ),
                    )); ?>
