    ...
    <div class="floatingBox" style="display: block;">
        <div class="container-fluid">
            ...
            <?php echo $form->errorSummary($model); ?>
                    ...
                    <div class="controls">
                        <?php echo $form->dropDownList($model,'title', Utils::getTitleCommon() ); ?>
                    </div>
                </div>
                            <div class="control-group">
            ...
            <fieldset class="fieldset_modules">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select name="SpeechTherapistSpecialEducationSchools[]" id="s2_6" multiple="multiple" class="span10 validate[required]" >
                            <?php
                            $cats = array(); SpecialEducationSchools::getTree($cats);
                            $selected = $model->getSpeechTherapistSpecialEducationSchoolsId();
                            foreach ($cats as $cat_id=>$cat){
                                echo '<optgroup  label="">';
                                if( isset( $cat ) )
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select name="SpeechTherapistAgencies[]" id="s2_9" multiple="multiple" class="span10 validate[required]" >
                            <?php
                            $cats = array(); Agencies::getTree($cats);
                            $selected = $model->getSpeechTherapistAgenciesId();
                            foreach ($cats as $cat_id=>$cat){
                                echo '<optgroup  label="">';
                                if( isset( $cat ) )
                                    echo '<option value="'.$cat_id.'"'.(in_array($cat_id, $selected)?' selected="selected"':'').'>'.$cat['corporate_name'].'</option>';
