...
<div class="containerHeadline tableHeadline">
    ...
    <form>
        <div class="input-append">
            <span class="add-on add-on-middle add-on-mini" onclick="window.location.href='<?php echo $this->createUrl('articles/create') ?>'"><i class="icon-plus-sign" title="<?php echo Yii::t('global','Create'); ?>"></i></span>
...
<div class="container-fluid">
    ...
    'columns'=>array(
        ...
        array(
            'name'=>'is_home',
            'header'=>Yii::t('global','Disable in home ?'),
            'type' => 'raw',
