...
<div class="container-fluid">
    <div class="page-header" style="border-bottom: 0px solid !important">
       ...
       <small><?php echo Yii::t('global', 'CentersCategory'); ?> #<?php echo $model->id; ?></small></h1>
    </div>
    <div class="row-fluid">
    ...
    <div class="row-fluid">
        <div class="span12">
            <div class="containerHeadline tableHeadline">
                ...
                <h2><?php echo Yii::t('global', 'CentersCategory'); ?> </h2>
                <form class="header-tab-view not-bor">
                    <div class="input-append">
                        <span class="add-on add-on-middle add-on-mini" onclick="window.location.href='<?php echo $this->createUrl('centersCategory/update?id=$model->id') ?>'"><i class="icon-edit" title="<?php echo Yii::t('adminlang', 'Edit'); ?>"></i></span>
