...
<div class="container-fluid">
    <div class="page-header" style="border-bottom: 0px solid !important;">
        <h1>
            <?php echo Yii::t('global', 'Export'); ?>            <small><?php echo Yii::t('global', 'Special Education Schools'); ?></small>
        </h1>
    </div>
    <div class="row-fluid">
                ...
                <div class="container-fluid">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            $this->widget('CJuiDateTimePicker',array(
                                'model'=>$model,
                                'name'=>"SpecialEducationSchools[fromdate]",
                                'mode'=>'datetime',
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            $this->widget('CJuiDateTimePicker',array(
                                'model'=>$model,
                                'name'=>"SpecialEducationSchools[todate]",
                                'mode'=>'datetime',
                                'options'=>array("dateFormat"=>Yii::app()->locale->getDateFormat('medium_js'), 'ampm' => false),
                                'language' => Yii::app()->language=='en'?'':Yii::app()->language,
                            )); ?>
