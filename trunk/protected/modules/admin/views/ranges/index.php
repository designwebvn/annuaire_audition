...
<div class="containerHeadline tableHeadline">
    ...
    <form>
        <div class="input-append">
            <span class="add-on add-on-middle add-on-mini" onclick="window.location.href='<?php echo $this->createUrl('ranges/create') ?>'"><i class="icon-plus-sign" title="<?php echo Yii::t('global','Create'); ?> "></i></span>
