...
<div class="containerHeadline tableHeadline">
    ...
    <form>
        <div class="input-append">
            <span class="add-on add-on-middle add-on-mini" onclick="window.location.href='<?php echo $this->createUrl('newspapersTitles/create') ?>'"><i class="icon-plus-sign" title="<?php echo Yii::t('global','Create'); ?>"></i></span>
...
<div class="container-fluid">
    ...
    <?php
    $Press    	= Press::getAllCategory();
    $this->widget('zii.widgets.grid.CGridView', array(
    'id'=>'newspapers-titles-grid',
