    ...
    <div class="floatingBox" style="display: block;">
        <div class="container-fluid">
            ...
            <?php echo $form->errorSummary($model); ?>
                    ...
                    <div class="controls">
                        <?php echo $form->textField( $model,'legal_status', array('size'=>60,'maxlength'=>255, 'class'=>'span10') ); ?>
                    </div>
                </div>

            <div class="control-group">
                <label for="fullname" class="control-label"><?php echo Yii::t('global', 'Brands')?></label>
                <div class="controls">
                    <select name="SupplierBrands[]" id="s2_2" multiple="multiple" class="span10 validate[required]" >
                        <?php
                        $cats = array(); Brands::getTree($cats);
                        $selected = $model->getIdSupplierBrains();
                    ...
                    <div class="controls">
                        <?php $this->widget('application.widgets.ckeditor.CKEditor', array( 'name' => 'Suppliers[grip_ent]', 'value' => isset($model->grip_ent) ? $model->grip_ent : '', 'editorTemplate' => 'basic' )); ?>
                    ...
                    <div class="controls">
                        <?php $this->widget('application.widgets.ckeditor.CKEditor', array( 'name' => 'Suppliers[description_ent_1]', 'value' => isset($model->description_ent_1) ? $model->description_ent_1 : '', 'editorTemplate' => 'full' )); ?>
                    ...
                    <div class="controls">
                        <?php $this->widget('application.widgets.ckeditor.CKEditor', array( 'name' => 'Suppliers[description_ent_2]', 'value' => isset($model->description_ent_2) ? $model->description_ent_2 : '', 'editorTemplate' => 'full' )); ?>
                    ...
                    <div class="controls">
                        <?php $this->widget('application.widgets.ckeditor.CKEditor', array( 'name' => 'Suppliers[description_ent_3]', 'value' => isset($model->description_ent_3) ? $model->description_ent_3 : '', 'editorTemplate' => 'full' )); ?>
                    ...
                    <div class="controls">
                        <?php $this->widget('application.widgets.ckeditor.CKEditor', array( 'name' => 'Suppliers[grip_hearing_aids]', 'value' => isset($model->grip_hearing_aids) ? $model->grip_hearing_aids : '', 'editorTemplate' => 'basic' )); ?>
                    ...
                    <div class="controls">
                        <?php $this->widget('application.widgets.ckeditor.CKEditor', array( 'name' => 'Suppliers[description_hearing_aids_1]', 'value' => isset($model->description_hearing_aids_1) ? $model->description_hearing_aids_1 : '', 'editorTemplate' => 'full' )); ?>
                    ...
                    <div class="controls">
                        <?php $this->widget('application.widgets.ckeditor.CKEditor', array( 'name' => 'Suppliers[description_hearing_aids_2]', 'value' => isset($model->description_hearing_aids_2) ? $model->description_hearing_aids_2 : '', 'editorTemplate' => 'full' )); ?>
                    ...
                    <div class="controls">
                        <?php $this->widget('application.widgets.ckeditor.CKEditor', array( 'name' => 'Suppliers[description_hearing_aids_3]', 'value' => isset($model->description_hearing_aids_3) ? $model->description_hearing_aids_3 : '', 'editorTemplate' => 'full' )); ?>
            ...
            <fieldset class="fieldset_modules">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select name="SupplierNews[]" id="s2_3" multiple="multiple" class="span10 validate[required]" >
                            <?php
                            $cats = array(); News::getTree($cats);
                            $selected = $model->getSupplierNewsId();
                            foreach ($cats as $cat_id=>$cat){
                                echo '<optgroup  label="">';
                                if( isset( $cat ) )
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select name="SupplierArticles[]" id="s2_1" multiple="multiple" class="span10"  >
                            <?php
                            $cats = array(); Products::getTree($cats);
                            $selected = $model->getSupplierArticlesId();
                            foreach ($cats as $cat_id=>$cat){
                                echo '<optgroup  label="">';
                                if( isset( $cat ) )
                                    echo '<option value="'.$cat_id.'"'.(in_array($cat_id, $selected)?' selected="selected"':'').'>'.$cat['name'].'</option>';
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select name="SupplierHearingTv[]" id="s2_4" multiple="multiple" class="span10 validate[required]" >
                            <?php
                            $cats = array(); Videos::getTree($cats);
                            $selected = $model->getSupplierHearingTvId();
                            foreach ($cats as $cat_id=>$cat){
                                echo '<optgroup  label="">';
                                if( isset( $cat ) )
                                    echo '<option value="'.$cat_id.'"'.(in_array($cat_id, $selected)?' selected="selected"':'').'>'.$cat['title'].'</option>';
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select name="SupplierEvents[]" id="s2_6" multiple="multiple" class="span10 validate[required]" >
                            <?php
                            $cats = array(); Events::getTree($cats);
                            $selected = $model->getSupplierEventsId();
                            foreach ($cats as $cat_id=>$cat){
                                echo '<optgroup  label="">';
                                if( isset( $cat ) )
                                    echo '<option value="'.$cat_id.'"'.(in_array($cat_id, $selected)?' selected="selected"':'').'>'.$cat['name'].'</option>';
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select name="SupplierAnnouncements[]" id="s2_5" multiple="multiple" class="span10"  >
                            <?php
                            $cats = array(); Announcements::getTree($cats);
                            $selected = $model->getSupplierAnnoucementsId();
                            foreach ($cats as $cat_id=>$cat){
                                echo '<optgroup  label="">';
                                if( isset( $cat ) )
