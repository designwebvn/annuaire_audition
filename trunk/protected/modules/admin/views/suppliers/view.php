            ...
            <div class="containerHeadline tableHeadline">
                ...
                <form class="header-tab-view not-bor">
                    <div class="input-append">
                        <span class="add-on add-on-middle add-on-mini" onclick="window.location.href='<?php echo $this->createUrl('suppliers/update?id='.$model->id) ?>'"><i class="icon-edit" title="<?php echo Yii::t('global', 'Edit'); ?>"></i></span>
            ...
            <div class="floatingBox table table-view-user">
                <div class="container-fluid">
                    ...
                    'attributes'=>array(
                        ...
                        array('name'=>Yii::t('global','Brands'), 'value'=>Suppliers::model()->getSupplierBrands($model->id), 'type'=>'raw'),
                        ...
                        array('name'=>'type', 'value'=>Suppliers::getStatus($model->type), 'type'=>'raw'),
                        array('name'=>'grip_ent','type'=>'raw'),
                        array('name'=>'description_ent_1','type'=>'raw'),
                        array('name'=>'description_ent_2','type'=>'raw'),
                        array('name'=>'description_ent_3','type'=>'raw'),
                        array('name'=>'grip_hearing_aids','type'=>'raw'),
                        array('name'=>'description_hearing_aids_1','type'=>'raw'),
                        array('name'=>'description_hearing_aids_2','type'=>'raw'),
                        array('name'=>'description_hearing_aids_3','type'=>'raw'),
                        ...
                        array('name'=>'zip'),
                        array('name'=>Yii::t('supplierProducts','News'), 'value'=>Suppliers::getSupplierNews($model->id ),'type'=>'html'),
                        array('name'=>Yii::t('events','Articles'), 'value'=>Suppliers::getSupplierArticles($model->id ),'type'=>'html'),
                        array('name'=>Yii::t('events','Hearing Tv'), 'value'=>Suppliers::getSupplierHearingTv($model->id ),'type'=>'html'),
                        array('name'=>Yii::t('events','Events'), 'value'=>Suppliers::getSupplierEvents($model->id ),'type'=>'html'),
                        array('name'=>Yii::t('events','Announcements'), 'value'=>Suppliers::getSupplierAnnoucements($model->id ),'type'=>'html'),
                        array('name'=>'created'),
                        array('name'=>'updated'),
                    ),
                    )); ?>
