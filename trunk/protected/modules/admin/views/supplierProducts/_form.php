    ...
    <div class="floatingBox" style="display: block;">
        <div class="container-fluid">
            ...
            <?php echo $form->errorSummary($model); ?>
                    ...
                    <div class="controls">
                        <?php echo $form->dropDownList( $model, 'is_activity', CHtml::listData(Activities::model()->findAll(),'id','name') ); ?>
                    </div>
                </div>
                            <div class="control-group">
                    ...
                    <div class="controls">
                        <?php echo $form->dropDownList($model,'is_brand',CHtml::listData(Brands::model()->findAll(),'id','name') ); ?>
                    </div>
                </div>
            <div class="control-group">
            ...
            <div class="control-group">
                    ...
                    <div class="controls">
                        <?php echo $form->dropDownList($model,'is_new_product',Utils::getStatusCommon()); ?>
                    </div>
                </div>
                            <div class="control-group">
                    ...
                    <div class="controls">
                        <?php echo $form->dropDownList($model,'is_disable_hightlight',Utils::getStatusCommon()); ?>
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select name="SupplierProductsChip[]" id="s2_2" multiple="multiple" class="span10 validate[required]" >
                            <?php
                            $cats = array(); Chips::getTree($cats);
                            $selected = $model->getIdSupplierProductsChip();
                ...
                <fieldset class="fieldset_modules">
                    ...
                    <div class="controls">
                        <select name="SupplierProductsHearingTV[]" id="s2_3" multiple="multiple" class="span10 validate[required]" >
                            <?php
                            $cats = array(); Videos::getTree($cats);
                            $selected = $model->getIdSupplierProductsVideo();
                            foreach ($cats as $cat_id=>$cat){
                                echo '<optgroup  label="">';
                                if( isset( $cat ) )
            ...
            <div class="control-group">
                <label for="fullname" class="control-label"><?php echo Yii::t('supplierProducts','Articles'); ?>
                </label>
                <div class="controls">
                    <select name="SupplierProductsArticles[]" id="s2_4" multiple="multiple" class="span10 validate[required]" >
                        <?php
                        $cats = array(); Products::getTree($cats);
                        $selected = $model->getIdSupplierProductsArticles();
                        foreach ($cats as $cat_id=>$cat){
                            echo '<optgroup  label="">';
                            if( isset( $cat ) )
                                echo '<option value="'.$cat_id.'"'.(in_array($cat_id, $selected)?' selected="selected"':'').'>'.$cat['name'].'</option>';
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <select name="SupplierProductsHearingCareCenters[]" id="s2_5" multiple="multiple" class="span10 validate[required]" >
                        <?php
                        $cats = array(); Centers::getTree($cats);
                        $selected = $model->getIdSupplierProductsCenters();
                        foreach ($cats as $cat_id=>$cat){
                            echo '<optgroup  label="">';
                            if( isset( $cat ) )
