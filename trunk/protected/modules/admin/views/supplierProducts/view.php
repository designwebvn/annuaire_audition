            ...
            <div class="containerHeadline tableHeadline">
                ...
                <form class="header-tab-view not-bor">
                    <div class="input-append">
                        <span class="add-on add-on-middle add-on-mini" onclick="window.location.href='<?php echo $this->createUrl('supplierProducts/update?id='.$model->id) ?>'"><i class="icon-edit" title="<?php echo Yii::t('global', 'Edit'); ?>"></i></span>
            ...
            <div class="floatingBox table table-view-user">
                <div class="container-fluid">
                    ...
                    'attributes'=>array(
                        ...
                        array('name'=>'is_activity', 'value'=>Activities::model()->getNameActivities($model->is_activity),'type'=>'raw'),
                        array('name'=>'is_brand', 'value'=>Brands::model()->getNameBrand($model->is_brand),'type'=>'raw'),
                        ...
                        array('name'=>'chip_id', 'value'=>SupplierProducts::getSupplierProductsChip($model->id ),'type'=>'raw'),
                        array('name'=>'link_hearingtv', 'value'=>SupplierProducts::getSupplierProductsVideo($model->id) ,'type'=>'raw'),
                        array('name'=>Yii::t('supplierProducts','Articles'), 'value'=>SupplierProducts::getSupplierProductsArticles($model->id) ,'type'=>'raw'),
                        array('name'=>Yii::t('supplierProducts','Hearing Care Centers'), 'value'=>SupplierProducts::getSupplierProductsCenters($model->id) ,'type'=>'raw'),
                        array('name'=>'created'),
                        array('name'=>'updated'),
                    ),
                    )); ?>
