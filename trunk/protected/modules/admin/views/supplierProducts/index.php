...
<div class="containerHeadline tableHeadline">
    ...
    <form>
        <div class="input-append">
            <span class="add-on add-on-middle add-on-mini" onclick="window.location.href='<?php echo $this->createUrl('supplierProducts/create') ?>'"><i class="icon-plus-sign" title="<?php  echo Yii::t('global','Create');  ?>"></i></span>
...
<div class="container-fluid">
    ...
    'columns'=>array(
		...
		array(
            'name'=>'is_new_product',
            'value'=>'SupplierProducts::getStatus($data->is_new_product)',
            'type'=>'raw',
            'filter'=>$status_common,
        ),
        array(
            'name'=>'is_best_sale',
            'value'=>'SupplierProducts::getStatus($data->is_best_sale)',
            'type'=>'raw',
            'filter'=>$status_common,
        ),
        array(
