    ...
    <div class="floatingBox" style="display: block;">
        <div class="container-fluid">
            ...
            <?php echo $form->errorSummary($model); ?>
                    ...
                    <label for="fullname" class="control-label"><?php echo Yii::t('global', 'COMPANY'); ?>
</label>
                    <div class="controls">
                    ...
                    <div class="controls">
                        <?php echo $form->textField($model,'phone',array('size'=>60,'maxlength'=>150, 'class'=>'span10')); ?>
                            ...
                            <div class="control-group">
                    <label for="fullname" class="control-label"><?php echo Yii::t('global', 'Category'); ?>
</label>
                    <div class="controls">
                        <?php
                    ...
                    <div class="controls">
                        <?php $this->widget('application.widgets.ckeditor.CKEditor', array( 'name' => 'Announcements[grip]', 'value' => isset($model->grip) ? $model->grip : '', 'editorTemplate' => 'basic' )); ?>
                    </div>
                </div>
                            <div class="control-group">
            ...
            <fieldset class="fieldset_modules">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select name="AnnouncementsHearingCareCenters[]" id="s2_5" multiple="multiple" class="span10 validate[required]" >
                            <?php
                            $cats = array(); Centers::getTree($cats);
                            $selected = $model->getAnnouncementsCentersId();
